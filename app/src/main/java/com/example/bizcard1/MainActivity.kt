    ...
    LazyColumn( ){
        items(data){
            ...
            Card(modifier = Modifier
                .padding(13.dp)
                .fillMaxWidth(), shape = RectangleShape, elevation = CardDefaults.cardElevation(4.dp)) {
                Row(modifier = Modifier
                    .padding(7.dp)
                    .background(MaterialTheme.colorScheme.surfaceVariant)) {

                    // No need to retype code for image
//                    Surface(modifier = Modifier.size(50.dp), shape = CircleShape) {
//
//                    }
                    CreateImageProfile(modifier = Modifier.size(100.dp))
                    Column(modifier = Modifier.padding(7.dp).align(alignment = Alignment.CenterVertically)){
                        Text(text = item, fontWeight = FontWeight.Black )
...
private fun CreateInfo() {
    Column(modifier = Modifier.padding(5.dp)) {
        ...
        Text(text = "LinkedIn:", style = MaterialTheme.typography.bodyMedium, color = Color.Black)
